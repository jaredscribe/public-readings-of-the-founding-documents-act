# Track A2 — The Commemorative Days Observance Act
...
> (S. 475 / H.R. 1320, 117th Cong.), which went to Senate Judiciary and House
> Oversight.
>
...
This Act may be cited as the *"Commemorative Days Observance Act"*.
...
title 36, United States Code, but is not among the legal public holidays named
in section 6103(a) of title 5, United States Code, and carries no paid-holiday
status of any kind.

**(2)** Independence Day and Juneteenth National Independence Day are both
legal public holidays under section 6103(a) of title 5, United States Code.
...
**(b) Entitlement.** — Each Federal employee shall be entitled, with respect to
the covered days, to **either**:
...
total number of paid holiday hours to which a Federal employee is entitled.
...
> **[DRAFTING NOTE — the arithmetic now works, which it did not before.]**
...
> the old formulation would have quietly *cut* benefits.
>
> Subsection (b)(2) restores exact neutrality on three days: one full day plus
> two half-days is sixteen hours, the same as two full days. This preserves the
> half-day concept — the original point of which was a morning devoted to
> reading and an afternoon of work — without touching the total.
>
> Subsection (c) is the whole political argument for this section, and it is
> only true so long as (b) is drafted as a fixed two-day-equivalent
> entitlement. If this is ever redrafted so half-days are added *on top of* the
...
> **[DRAFTING NOTE — the elective mechanism is administratively novel and
> needs its own research pass.]** Nothing in 5 U.S.C. § 6103 resembles this.
...
> statute. Whether § 6103 can carry an employee-elective entitlement at all, and
...
> Legislative Counsel consultation before introduction.
>
> Expect CBO to score this regardless of the neutrality framing.

> **[DRAFTING NOTE — a jurisdictional wrinkle.]** Sec. 3 is drafted as a
...
> **[DRAFTING NOTE — reduce this to a CRS directive if the commission is too
...
> plausible candidate in either bill for attachment to a must-pass vehicle.
>
> Note the jurisdictional consequence: a CRS directive goes to **House
> Administration / Senate Rules and Administration**, because CRS is part of
> the Library of Congress — the *only* place in this whole package where those
> committees are in fact the right answer.

> **[DRAFTING NOTE — subsection (b)(2) now overlaps a live proposal.]** The
...
> the relationship among Memorial Day, Veterans Day and Juneteenth, and a bill
> that *acts* on it, should not proceed as though the other does not exist. The
...
> **[DRAFTING NOTE — (b)(4) is the most sensitive item here.]** It is drafted
